...
jQuery.fn.pagination = function(maxentries, opts){
	...
	return this.each(function() {
		...
		function drawLinks() {
			...
			var pagetext = '<input id="pagevalue" size="1" value="'+(current_page+1)+'"type="text"> 页';
			var tosumPage = '<label style="margin-right: 0px;padding-right: 5px">共</label>'+np+'<label style="margin-right: 0px;padding: 8px 5px">页，跳转至</label>';
			var toPage = '<label><a id="search" href="#" style="position: relative;top: 1px;margin-left: 20px">确定</a></label>';
